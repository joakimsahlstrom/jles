...
public class EventStoreSessionTest {
	...
	private final EventStoreConfigurer configurer = EventStoreConfigurer.createFileBasedConfigurer(fileChannelFactory).eventIndexing(EventIndexingSingleFileConfiguration.create());
