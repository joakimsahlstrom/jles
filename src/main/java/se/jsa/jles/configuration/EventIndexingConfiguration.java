...
public interface EventIndexingConfiguration {

	EventIndexing createIndexing(EventDefinitions eventDefinitions, EntryFileCreator entryFileFactory, EntryFileNameGenerator entryFileNameGenerator);
